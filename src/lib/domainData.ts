...
export const domains: Domain[] = [
  {
    ...
    description:
      "Build and maintain software applications, systems, and networks.",
    icon: "Code",
    roles: [
      {
        id: "frontend-dev",
        ...
        description:
          "Focus on the user interface and user experience of web applications.",
        roadmap: [
          {
            step: "Basics",
          ...
          {
            step: "Frameworks",
            description: "Master a framework like React or Vue",
            duration: "2-3 Months",
          },
          {
            step: "State Management",
            description: "Learn Redux, Context API",
            duration: "1 Month",
          },
          {
            step: "Build Tools",
            description: "Understand Vite, Webpack, Git",
            duration: "1 Month",
          },
        ],
      ...
      },
      {
        ...
        roadmap: [
          ...
          {
            step: "Databases",
            description: "Understand SQL (Postgres) & NoSQL (MongoDB)",
            duration: "1-2 Months",
          },
          {
            step: "API Design",
            description: "Learn REST & GraphQL principles",
            duration: "1 Month",
          },
          {
            step: "Deployment",
            description: "Master Docker, AWS basics, CI/CD",
            duration: "1-2 Months",
          },
        ],
      ...
      },
      {
        ...
        roadmap: [
          ...
          {
            step: "DevOps",
            description: "Deployment, CI/CD, Cloud",
            duration: "1-2 Months",
          },
          {
            step: "Architecture",
            description: "System Design & Scalability",
            duration: "1 Month",
          },
        ],
    ...
    roles: [
      {
        ...
        description:
          "Conduct research to advance the field of AI and discover new algorithms.",
        roadmap: [
          {
            step: "Mathematics",
          ...
          {
            step: "Specialization",
            description: "NLP, Computer Vision, or RL",
            duration: "3 Months",
          },
        ],
      ...
      },
      {
        ...
        roadmap: [
          ...
          {
            step: "Ethics & Policy",
            description: "Study bias, fairness, and regulations",
            duration: "2 Months",
          },
          {
            step: "Auditing Tools",
            description: "Learn tools to detect bias in models",
            duration: "1-2 Months",
          },
          {
            step: "Compliance",
            description: "GDPR, AI Act, Legal frameworks",
            duration: "1 Month",
          },
        ],
  ...
  },
  {
    ...
    description:
      "Build and deploy algorithms that allow computers to learn from data.",
    icon: "Cpu",
    roles: [
      {
        id: "ml-engineer",
        ...
        roadmap: [
          {
            step: "Foundations",
            description: "Python, NumPy, Pandas",
            duration: "1 Month",
          },
          {
            step: "ML Algorithms",
          ...
          {
            step: "Deep Learning",
            description: "TensorFlow or PyTorch",
            duration: "2-3 Months",
          },
          {
            step: "MLOps",
            description: "Model deployment, Docker, Kubernetes",
            duration: "2 Months",
          },
        ],
      ...
      },
      {
        ...
        title: "NLP Engineer",
        description:
          "Work on systems that understand and generate human language.",
        roadmap: [
          {
            step: "Linguistics",
            description: "Basic understanding of language structure",
            duration: "1 Month",
          },
          {
            step: "Text Processing",
            description: "Tokenization, Stemming, Regex",
            duration: "1 Month",
          },
          {
            step: "NLP Models",
            description: "RNNs, LSTMs, Transformers (BERT/GPT)",
            duration: "3 Months",
          },
          {
            step: "Libraries",
            description: "Hugging Face, SpaCy, NLTK",
            duration: "1-2 Months",
          },
        ],
    ...
    roles: [
      {
        ...
        description:
          "Design and manage cloud computing strategies and architecture.",
        roadmap: [
          {
            step: "Networking",
            description: "DNS, TCP/IP, HTTP, VPNs",
            duration: "1-2 Months",
          },
          {
            step: "Cloud Provider",
          ...
          {
            step: "Security",
            description: "IAM, Firewalls, Compliance",
            duration: "1 Month",
          },
        ],
      ...
      },
      {
        ...
        description:
          "Bridge the gap between development and operations using automation.",
        roadmap: [
          {
            step: "OS & Scripting",
            description: "Linux, Bash, Python",
            duration: "1-2 Months",
          },
          {
            step: "CI/CD",
  ...
  },
  {
    ...
    title: "Data Science",
    description:
      "Analyze data to extract insights and build intelligent systems.",
    icon: "Database",
    roles: [
      {
        id: "data-analyst",
        ...
        roadmap: [
          {
            step: "Spreadsheets",
            description: "Advanced Excel/Google Sheets",
            duration: "1 Month",
          },
          {
            step: "SQL",
            description: "Querying databases, Joins, Aggregations",
            duration: "1-2 Months",
          },
          {
            step: "Visualization",
    ...
    roles: [
      {
        ...
        roadmap: [
          ...
          {
            step: "OS Security",
            description: "Windows/Linux hardening",
            duration: "1 Month",
          },
          {
            step: "Tools",
            description: "Wireshark, Nmap, SIEM tools",
            duration: "1-2 Months",
          },
          {
            step: "Certifications",
            description: "CompTIA Security+, CEH",
            duration: "2-3 Months",
          },
        ],
        ...
        roadmap: [
          {
            ...
            description: "User interviews, Competitor analysis",
            duration: "1 Month",
          },
          {
            step: "Agile/Scrum",
            description: "Jira, Sprints, User Stories",
            duration: "1 Month",
          },
          {
            step: "Strategy",
            description: "Product Vision, Roadmapping, KPIs",
            duration: "1-2 Months",
          },
          {
            step: "Tech Basics",
            description: "Understand APIs, DBs to talk to devs",
            duration: "1 Month",
          },
        ],
