          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                These students have signed up but are not yet verified. Verify
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Search and manage all verified students associated with your
                college.
              </p>
            </div>
          </div>
                    ...
                    <TableCell>
                      {!student.isVerified && (
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            student._id && handleVerify(student._id)
                          }
                        >
                          <CheckCircle2 className="h-4 w-4 mr-1" />
                          Verify
