...
const StudentDashboardPage = () => {
  ...
  const nextInterview = sortedInterviews.length > 0
    ? sortedInterviews[0]
    : null;
  ...
  const successRate = totalApplications > 0
    ? Math.round((applicationStatusBreakdown.offered / totalApplications) * 100)
    : 0;

  // Calculate response rate (any response / total)
  const responseRate = totalApplications > 0
    ? Math.round(
        ((totalApplications - applicationStatusBreakdown.applied) / totalApplications) * 100
      )
    : 0;
  ...
  const getJobIcon = (title: string, jobType?: string) => {
    ...
    if (lowerTitle.includes("frontend") || lowerTitle.includes("front-end") || lowerTitle.includes("react") || lowerTitle.includes("angular") || lowerTitle.includes("vue")) {
      return Code;
    }
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="hover:shadow-lg transition-all bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-blue-900 dark:text-blue-100">Active Applications</CardTitle>
              <div className="p-2 bg-blue-500 rounded-lg shadow-sm">
                <Send className="h-4 w-4 text-white" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-900 dark:text-blue-100">{activeApplications.length}</div>
          ...
          <Card className="hover:shadow-lg transition-all bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 border-purple-200 dark:border-purple-800">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-purple-900 dark:text-purple-100">Upcoming Interviews</CardTitle>
              <div className="p-2 bg-purple-500 rounded-lg shadow-sm">
                <Video className="h-4 w-4 text-white" />
                </div>
              </CardHeader>
              <CardContent>
              <div className="text-2xl font-bold text-purple-900 dark:text-purple-100">{interviewScheduledApps.length}</div>
              {nextInterview ? (
                <p className="text-xs text-purple-700 dark:text-purple-300 mt-1">
                  Next: {formatInterviewDate(nextInterview.updatedAt || nextInterview.createdAt)}
                </p>
              ) : (
                <p className="text-xs text-purple-600 dark:text-purple-400 mt-1">No interviews scheduled</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-all bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 border-emerald-200 dark:border-emerald-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-emerald-900 dark:text-emerald-100">My Mentors</CardTitle>
              <div className="p-2 bg-emerald-500 rounded-lg shadow-sm">
                <Users className="h-4 w-4 text-white" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-emerald-900 dark:text-emerald-100">{activeMentorshipsCount}</div>
              <p className="text-xs text-emerald-700 dark:text-emerald-300 mt-1 flex items-center gap-1">
                <MessageSquare className="h-3 w-3" />
                {activeMentorshipsCount > 0 ? "Active mentorships" : "No active mentors"}
                </p>
              </CardContent>
            </Card>
      </div>
        ...
        <CardHeader>
            ...
            <CardContent className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-indigo-700 dark:text-indigo-300">Response Rate</span>
                  <span className="text-sm font-semibold text-indigo-900 dark:text-indigo-100">{responseRate}%</span>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-indigo-700 dark:text-indigo-300">Success Rate</span>
                  <span className="text-sm font-semibold text-indigo-900 dark:text-indigo-100">{successRate}%</span>
                </div>
                <div className="relative h-2.5 w-full overflow-hidden rounded-full bg-indigo-200 dark:bg-indigo-800">
                  <div
              ...
              <div className="pt-2 border-t border-indigo-200 dark:border-indigo-800">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-indigo-700 dark:text-indigo-300">Offers Received</span>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 border-orange-200 dark:border-orange-800">
            <CardHeader>
              <CardTitle className="text-base text-orange-900 dark:text-orange-100">Status Breakdown</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/50 dark:bg-orange-900/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-orange-900 dark:text-orange-100">Applied</span>
                </div>
                <span className="text-sm font-semibold text-orange-900 dark:text-orange-100">{applicationStatusBreakdown.applied}</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/50 dark:bg-orange-900/50">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-yellow-500 shadow-sm"></div>
                  <span className="text-sm font-medium text-orange-900 dark:text-orange-100">Under Review</span>
                </div>
                <span className="text-sm font-semibold text-orange-900 dark:text-orange-100">{applicationStatusBreakdown.underReview}</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/50 dark:bg-orange-900/50">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-green-500 shadow-sm"></div>
                  <span className="text-sm font-medium text-orange-900 dark:text-orange-100">Interviewing</span>
                </div>
                <span className="text-sm font-semibold text-orange-900 dark:text-orange-100">{applicationStatusBreakdown.interviewing}</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/50 dark:bg-orange-900/50">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-green-600 shadow-sm"></div>
                  <span className="text-sm font-medium text-orange-900 dark:text-orange-100">Offered</span>
                </div>
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/50 dark:bg-orange-900/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-orange-900 dark:text-orange-100">Rejected</span>
                </div>
                <span className="text-sm font-semibold text-orange-900 dark:text-orange-100">{applicationStatusBreakdown.rejected}</span>
          </div>
        </CardContent>
      </Card>
          ...
          <Card className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-950 dark:to-pink-900 border-pink-200 dark:border-pink-800">
            ...
            <CardContent>
              <div className="text-3xl font-bold mb-2 text-pink-900 dark:text-pink-100">{eventRegistrations.length}</div>
              {eventsThisWeek > 0 && (
              ...
              {upcomingEvents.length > 0 && (
                <div className="space-y-2">
                  <p className="text-xs font-medium text-pink-700 dark:text-pink-300">Upcoming</p>
                  {upcomingEvents.slice(0, 2).map((event) => {
                    const { month, day } = formatEventDate(event.eventDate);
                    return (
                      <div key={event._id} className="flex items-center gap-2 text-sm p-2 rounded-lg bg-white/50 dark:bg-pink-900/50">
                        <Calendar className="h-4 w-4 text-pink-600 dark:text-pink-400" />
                        <span className="flex-1 truncate text-pink-900 dark:text-pink-100 font-medium">{event.title}</span>
                        <span className="text-xs text-pink-700 dark:text-pink-300">{month} {day}</span>
                      </div>
                    );
                  })}
                </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {/* Recent Applications */}
          <Card className="lg:col-span-2 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 border-slate-200 dark:border-slate-700">
            ...
            <div>
                <CardTitle className="text-lg text-slate-900 dark:text-slate-100">Recent Applications</CardTitle>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">
                  Track your latest job applications
                </p>
            </div>
              <Button asChild variant="ghost" size="sm" className="text-sm hover:bg-slate-200 dark:hover:bg-slate-700">
                ...
                {recentApplications.map((app) => {
                  ...
                  return (
                    <div
                      ...
                      >
                        <div className={`${iconColor} mt-0.5 flex-shrink-0 p-2 rounded-lg ${getIconBgColor(job.title)}`}>
                          <JobIcon className="h-5 w-5" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2 mb-1.5">
                            <h4 className="font-semibold text-sm leading-tight text-slate-900 dark:text-slate-100">{job.title}</h4>
        ...
        {/* Upcoming Events */}
          <Card className="bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-950 dark:to-cyan-900 border-cyan-200 dark:border-cyan-800">
            ...
            <div>
              ...
              <Button asChild variant="ghost" size="sm" className="text-sm hover:bg-cyan-200 dark:hover:bg-cyan-800">
              <Link to="/events">
                View All
                  <ArrowRight className="h-4 w-4 ml-1 inline" />
              </Link>
                    ...
                    key={event._id}
                      ...
                      >
                        <div className="flex flex-col items-center min-w-[60px] flex-shrink-0 p-2 rounded-lg bg-cyan-100 dark:bg-cyan-900">
                          ...
                          <div className="text-lg font-bold text-cyan-900 dark:text-cyan-100">{day}</div>
                        </div>
                        <div className="flex-1 min-w-0">
          ...
          <div>
              ...
              <Button asChild variant="ghost" size="sm" className="text-sm hover:bg-teal-200 dark:hover:bg-teal-800">
            ...
            {activeMentors.length > 0 ? (
              ...
              return (
                    ...
                    >
                      ...
                      <Button variant="ghost" size="icon" className="ml-2 flex-shrink-0 hover:bg-teal-200 dark:hover:bg-teal-800 rounded-full">
